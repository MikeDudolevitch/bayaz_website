      ...
      <div className="">
        <h1 className="section-title">About</h1>
          <div id='about-paragraph'>
            ...
            {/* <div className="story"> */}
              <img id='about-img' alt='placeholder pic' src='./pics/site-pics/bayazpicouttake.jpeg'></img>
                ...
                <br></br><br></br>
                In 2021, they went into <a className="boxTextShadow" href="https://www.studiogbrooklyn.com/studio/">Studio G</a> in Greenpoint, Brooklyn, to record a full-length LP with Jeff Berner (<a className="boxTextShadow" href='https://www.daisrecords.com/collections/psychic-tv'>Psychic TV</a>) at the controls. Having finished tracking, mixing, and mastering (the latter courtesy of <a className="boxTextShadow" href='https://saffmastering.com/'>Carl Saff</a>), Bayaz signed to New Jersey-based independent label <a className="boxTextShadow"href='https://fakechapter.com/'>Fake Chapter Records</a> to release the record in Spring '23. The first double A-side single, “Found Money” and “Circle”, is set to be released in November 2022. They will be playing regionally through '22 and touring to support the Bayaz LP in 2023. Be sure to check the <a className="boxTextShadow" href='#shows'>Shows</a> section to see if they roll through a city near you!
